...
class HostedOAuthConfig:
    ...
    # through the token audience. Its current introspection response does not
    # expose custom resource scopes, so scope enforcement is opt-in for providers
    # that actually issue and introspect them.
